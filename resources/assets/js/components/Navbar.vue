<template>
    <header class="bg-inherit">
        <div id="nav" class="main-nav max-w-2xl mx-auto flex justify-between items-center p-4 md:p-0">
            <a href="/" class="w-32 md:w-48 lg:w-64">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1409.44 406.89">
                    <rect class="text-blue-navy fill-current" x="13.32" y="13.32" width="380.26" height="380.26" rx="40.69" ry="40.69" transform="rotate(-5.36 203.613 203.508)" fill="#293452"/>
            ...
            <label for="mainNavTogger" class="text-blue-lightest mb-0 hover:text-white md:hidden"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="fill-current w-6 h-6"><path d="M25 3c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 16c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 16c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6z"/></svg></label>
            ...
            <nav class="invisible fixed pin flex flex-col md:visible md:static md:flex md:flex-row justify-center items-center text-center text-xl md:text-sm lg:text-base bg-blue md:bg-transparent z-10">
               ...
               <a href="/about" class="text-blue-lightest hover:text-white no-underline p-3 md:px-2">About us</a>
               <a href="/blog" class="text-blue-lightest hover:text-white no-underline p-3 md:px-2">Posts</a>
