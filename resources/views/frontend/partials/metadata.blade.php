...
<meta itemprop="name" content="{!!  isset($metadata['title']) ? $metadata['keywords'] : config('laraveluk.site.name') !!}">
...
<meta property="og:title" content="{!!  isset($metadata['title']) ? $metadata['keywords'] : config('laraveluk.site.name') !!}">
...
<meta name="twitter:title" content="{!!  isset($metadata['title']) ? $metadata['keywords'] : config('laraveluk.site.name') !!}">
...
<script type="text/javascript">
        //   var _gaq = _gaq || [];
        //   _gaq.push(['_setAccount', '{{ config('premier.google.code') }}']);
