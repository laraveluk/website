<div class="text-center mx-auto mb-8 w-3/4">
    <h2 class="text-blue-navy text-2xl border-b-2 border-grey mb-4 md:text-3xl">Special Thanks To Our Sponsors</h3>
    <div class="flex items-center">
        <p class="leading-normal text-grey-darkest md:text-lg">
