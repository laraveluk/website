...
@section('title_and_meta')
    <title>LaravelUK - Create Post</title>
    <meta name="title" content="LaravelUK - Create Post" />
    <meta name="description" content="LaravelUK - Create Post" />
    <meta name="og_title" content="LaravelUK - Create Post" />
    <meta name="og_description" content="LaravelUK - Create Post" />
@stop
            ...
            <div class="w-full">
                <form method="POST" action="{{route('posts.store')}}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-3" id="body" name="body" type="body" rows="10"></textarea>
                    </div>
